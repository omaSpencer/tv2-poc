...
**Megvalósítási státusz (2026-09-17):** az M0 alap és infrastruktúra, az M1 tranzakciós CMS-életciklus, az M2 identity resource server, az M3 outbox → JetStream relay, az **M4 kétindexes kereshető katalógus**, valamint az M5 reindex/karantén/repair vezérlősík implementálva a [`poc/backend/`](backend/) könyvtárban. A frontend Release A, Release B és a Release C Fázis 5 **kész**: valódi Authentik PKCE belépéssel, UUID-másolás nélküli editor/publisher workspace-szel, katalógussal, operations dashboarddal, továbbá idempotens reindex, payloadmentes karantén-replay és kétindexes repair UI-val. A Phase 5 normál, Meilisearch-kieséses és valódi backend-crash/restart E2E-vel bizonyított. Jegyzőkönyvek: [Release A](RELEASE-A-EVIDENCE.md), [Release B](RELEASE-B-EVIDENCE.md), [Phase 5](PHASE-5-EVIDENCE.md). A korábbi mérföldkő-jegyzőkönyvek: [M0–M1](M0-M1-EVIDENCE.md), [M2](M2-EVIDENCE.md), [M3](M3-EVIDENCE.md), [M4](M4-EVIDENCE.md), [M5](M5-EVIDENCE.md). **Nyitott:** a Release C Fázis 6–7, az M2 token-refresh/key-rotation/IdP-kiesés kibővített L2 mérései, az M5 1000+100 teljesítménybaseline és az M6 média.
