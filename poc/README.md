...
**Megvalósítási státusz (2026-09-17):** az M0–M5 backend és a frontend Release A, B és C **kész**. A szerkesztői, katalógus-, operations-, operátori és scenario workspace valódi Authentik/PostgreSQL/NATS/Meilisearch A/B stacken bizonyított; a Fázis 7 CI-, accessibility-, responsive-, browser-, security-, bundle- és fresh-checkout kapuja lezárt. Jegyzőkönyvek: [Release A](RELEASE-A-EVIDENCE.md), [Release B](RELEASE-B-EVIDENCE.md), [Release C](RELEASE-C-EVIDENCE.md), [Phase 7](PHASE-7-EVIDENCE.md). A korábbi mérföldkő-jegyzőkönyvek: [M0–M1](M0-M1-EVIDENCE.md), [M2](M2-EVIDENCE.md), [M3](M3-EVIDENCE.md), [M4](M4-EVIDENCE.md), [M5](M5-EVIDENCE.md). **Release-en kívüli hardening:** M2 token-refresh/key-rotation/IdP-kiesés hosszú L2 mérés, M5 1000+100 kapacitásbaseline és M6 média.
